      ...
      <div className={cn("transition-all duration-300", isScrolled ? "bg-card text-card-foreground" : "bg-primary text-primary-foreground")}>
        <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-6">
            ...
            {isScrolled && (
              <CategoriesMenu>
                <Button variant="ghost" className="hidden md:flex text-base font-bold gap-2 text-primary">
          ...
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-2">
              <Button variant="ghost" size="icon" className={cn("rounded-full h-11 w-11", isScrolled && "border border-muted-foreground")}>
                  <User className={cn(isScrolled && "text-muted-foreground")} />
                  <span className="sr-only">Compte</span>
              </Button>
              <Button variant="ghost" size="icon" className={cn("rounded-full h-11 w-11", isScrolled && "border border-muted-foreground")}>
                  <Heart className={cn(isScrolled && "text-muted-foreground")} />
                  <span className="sr-only">Favoris</span>
              </Button>
              <Button asChild variant="ghost" size="icon" className={cn("rounded-full h-11 w-11", isScrolled && "border border-muted-foreground")}>
                <Link href="/cart" className="relative">
                    <ShoppingCart className={cn(isScrolled && "text-muted-foreground")} />
